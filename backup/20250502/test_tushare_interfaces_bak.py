...
def test_tushare_interfaces():
    ...
    financial_interfaces = [
        ...
        {"name": "业绩预告", "func": lambda: pro.forecast(period='20230930', fields='ts_code,ann_date,end_date,type,p_change_min,p_change_max')},
    ...
    market_interfaces = [
        ...
        {"name": "北向资金", "func": lambda: pro.moneyflow_hsgt(start_date=(datetime.now() - timedelta(days=60)).strftime('%Y%m%d'), end_date=end_date)},
